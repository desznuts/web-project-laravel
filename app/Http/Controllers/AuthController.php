...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        $activeSession = SessionToken::where('user_id', $user->id)->orderBy('created_at', 'desc')->first();
    ...
    public function logout(Request $request)
    {
        ...
        $sessionsToDelete = SessionToken::where('user_id', $user->id)
            ->orderBy('created_at', 'desc')
            ->take(100) // Limit to last 100 sessions (adjust as needed)
            ->get();
